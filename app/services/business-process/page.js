...
export const metadata = {
  ...
  description: 'End-to-end business process management for manufacturing and trade operations. Back-office support, compliance, documentation, and operations management.',
}
...
const processes = [
  {
    title: 'Procurement & Vendor Admin',
    description: 'End-to-end management of purchase orders, vendor communications, quotes, and contract administration so your team can focus on strategy.',
    icon: '📋',
    highlights: ['PO creation and tracking', 'Vendor onboarding', 'Quote comparison', 'Contract management'],
  },
  {
    title: 'Trade & Compliance',
    description: 'Navigate international trade documentation, customs compliance, and export/import regulations across India, Canada, and the USA.',
    icon: '🌐',
    highlights: ['Import/export documentation', 'HS code classification', 'Customs coordination', 'Regulatory compliance'],
  },
  {
    title: 'Operations & Reporting',
    description: 'Keep your operations running smoothly with regular reporting, KPI tracking, and back-office coordination managed from our India team.',
    icon: '📊',
    highlights: ['Weekly operations reports', 'KPI dashboards', 'Cost tracking', 'Shipment coordination'],
  },
]
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <span className="inline-block px-4 py-1.5 bg-amber-500/10 border border-amber-500/30 rounded-full text-amber-500 text-sm font-medium mb-6">
                Back-Office to Front-Line
              </span>
              <h1 className="text-4xl md:text-5xl font-display font-bold text-white mb-6">
                Business Process Services
              </h1>
              <p className="text-lg text-white/70 mb-8">
                Let our India-based team handle your back-office operations — procurement admin, trade compliance, reporting, and more — so your core team can focus on growth.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                { value: '60%', label: 'Lower than domestic BPO' },
                { value: '24hr', label: 'Typical turnaround' },
                { value: '100%', label: 'Dedicated to your account' },
